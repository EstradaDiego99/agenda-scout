...
export default function InsigniasManada({ selfProfile, CUM, historial }) {
  ...
  const imgProgresion = !progresion ? (
    <img
      src={progresiones.manada[0]}
      alt="Ninguna progresión"
      className="greyscale"
    ></img>
  ) : (
    <img
      src={progresiones.manada[progresion - 1]}
  ...
  const imgAmbiente = !ambiente ? (
    <img
      src={insigniasIDS.manada.ambiente.img}
  ...
  const imgDesarrollo = !desarrollo ? (
    <img
      src={insigniasIDS.manada.desarrollo.img}
  ...
  const imgPaz = !paz ? (
    <img
      src={insigniasIDS.manada.paz.img}
      alt="Insignia de Paz Deshabilitada"
      className="greyscale"
    ></img>
  ) : (
    <img src={insigniasIDS.manada.paz.img} alt="Insignia de Paz"></img>
  );
  ...
  if (editMode) {
    return (
      <section className="pt-2 pb-2 mb-4 text-center">
        ...
        <div className="insignias-manga-container manada edit-mode">
  ...
  return (
    <section className="pt-2 pb-2 mb-4 text-center">
      ...
      <div className="insignias-manga-container manada">
