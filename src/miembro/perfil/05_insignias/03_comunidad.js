...
export default function InsigniasComunidad({ selfProfile, CUM, historial }) {
  ...
  const progresionesMap = ["Búsqueda", "Encuentro", "Desafío"];

  const imgProgresion = !progresion ? (
    <img
      src={progresiones.comunidad[0]}
      alt="Ninguna progresión"
      className="greyscale"
    ></img>
  ) : (
    <img
      src={progresiones.comunidad[progresion - 1]}
  ...
  const imgAmbiente = !ambiente ? (
    <img
      src={insigniasIDS.comunidad.ambiente.img}
  ...
  const imgDesarrollo = !desarrollo ? (
    <img
      src={insigniasIDS.comunidad.desarrollo.img}
  ...
  const imgPaz = !paz ? (
    <img
      src={insigniasIDS.comunidad.paz.img}
      alt="Insignia de Paz Deshabilitada"
      className="greyscale"
    ></img>
  ) : (
    <img src={insigniasIDS.comunidad.paz.img} alt="Insignia de Paz"></img>
  );
  ...
  if (editMode) {
    return (
      <section className="pt-2 pb-2 mb-4 text-center">
        ...
        <div className="insignias-manga-container comunidad edit-mode">
          <div className="especialidades-container">
            <button
              className="progresion"
              onClick={() => setProgresion((progresion + 1) % 4)}
            >
              {imgProgresion}
            </button>
            <button
  ...
  return (
    <section className="pt-2 pb-2 mb-4 text-center">
      ...
      <div className="insignias-manga-container comunidad">
